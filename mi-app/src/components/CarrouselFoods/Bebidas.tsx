...
import bebida1 from '../../assets/Rectangle 159 (9).png'
import bebida2 from '../../assets/Rectangle 159 (10).png'
import bebida3 from '../../assets/Rectangle 159 (11).png'
...
const Bebidas = () => {
    ...
    const dishes = [
        { name: "Nombre", price: "00.00$", imageUrl: bebida1 },
        { name: "Nombre", price: "00.00$", imageUrl: bebida2 },
        { name: "Nombre", price: "00.00$", imageUrl: bebida3 }
    ];
