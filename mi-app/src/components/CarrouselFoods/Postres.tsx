...
import postre1 from '../../assets/Rectangle 159 (6).png'
import postre2 from '../../assets/Rectangle 159 (7).png'
import postre3 from '../../assets/Rectangle 159 (8).png'
...
const Postres = () => {
    ...
    const dishes = [
        { name: "Nombre", price: "00.00$", imageUrl: postre1 },
        { name: "Nombre", price: "00.00$", imageUrl: postre2 },
        { name: "Nombre", price: "00.00$", imageUrl: postre3 }
    ];
