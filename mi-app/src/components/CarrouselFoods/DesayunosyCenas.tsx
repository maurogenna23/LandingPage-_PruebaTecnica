...
import desayuno1 from '../../assets/Rectangle 159 (3).png'
import desayuno2 from '../../assets/Rectangle 159 (4).png'
import desayuno3 from '../../assets/Rectangle 159 (5).png'


const DesayunosYCenas = () => {
    ...
    const dishes = [
        { name: "Nombre", price: "00.00$", imageUrl: desayuno1 },
        { name: "Nombre", price: "00.00$", imageUrl: desayuno2 },
        { name: "Nombre", price: "00.00$", imageUrl: desayuno3 }
    ];
...
export default DesayunosYCenas;
